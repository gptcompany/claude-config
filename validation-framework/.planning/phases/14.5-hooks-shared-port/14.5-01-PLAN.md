...
<task type="auto">
  <name>Task 3: Create metrics.js</name>
  <files>~/.claude/scripts/lib/metrics.js</files>
  <action>
1. Port QuestDB client functionality
2. Implement:
