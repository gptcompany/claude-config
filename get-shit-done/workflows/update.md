...
if [ -f ./.claude/get-shit-done/VERSION ]; then
  ...
  echo "LOCAL"
elif [ -f /home/sam/.claude/get-shit-done/VERSION ]; then
  cat /home/sam/.claude/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
fi
...
(Paths are relative to your install location: `/home/sam/.claude/` for global, `./.claude/` for local)
...
**If GLOBAL install:**
```bash
rm -f /home/sam/.claude/cache/gsd-update-check.json
```
